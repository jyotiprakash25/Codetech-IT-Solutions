...
def send_message():
    ...
    if "hi" in u:
        ...
        bot = Label(chat_bg,height=1,width=64,bg="white",fg="black",text="Bot> Do not understand you",font=12,anchor="e")
        bot.place(x=xi,y=yi+25)
    yi+=50
...
hcb_text = Label(height=2, width=14, bg="#0084ff", text="Chatbot" ,font=("Impact",20),fg="white")
